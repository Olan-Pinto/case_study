...
4. **Find whitespace:** select a cell, inspect its PRIORITIZE/WATCH/DEPRIORITIZE research score and exact four-factor arithmetic, or see why missing required evidence withheld the score. These labels order follow-up research; they are not growth recommendations.
