...
| Opportunity classification | H3 cells, demand/amenity proxy, competitors, own coverage | `whitespace_model_v1` | Opportunity layer + detail drawer | Contributions, uncertainty, sources | H3/geometry/label-boundary tests | Click a cell and explain GROW/WATCH/SKIP |
